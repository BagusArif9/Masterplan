...
const KonturTopografi: NextPage = () => {
  return (
    <Box
      ...
      >
        <Box w="full" p={4} border="2px solid" borderColor="black">
          <Heading fontSize="3xl">
            PETA KONTUR TOPOGRAFI <br/> AGROWISATA MEJING
          </Heading>
        ...
        <Box w="full" p={4} border="2px solid" borderColor="black">
          ...
          <Image
            src="/maps/kontur/legendaKontur.svg"
            alt="Your Image"
            objectFit="contain"
            width="100%"
          />
        ...
        <Box w="full" p={4} border="2px solid" borderColor="black">
          ...
          <VStack>
            <Text fontSize="md" px={2} as="b">
              Data Badan Informasi Geospasial<br/> Data DEMNAS Kabupaten Semarang <br/> Peta RTRW Kabupaten Semarang
              2023-2024
            </Text>
          </VStack>
        </Box>
...
export default KonturTopografi;
