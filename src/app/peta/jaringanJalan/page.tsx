...
const BatasAgrowisata: NextPage = () => {
  return (
    <Box
      ...
      >
        <Box w="full" p={4} border="2px solid" borderColor="black">
          <Heading fontSize="3xl">
            PETA JARINGAN JALAN <br/> AGROWISATA MEJING
          </Heading>
        ...
        <Box w="full" p={4} border="2px solid" borderColor="black">
          ...
          <Image
            src="/maps/jaringanJalan/legenda_JJ.svg"
            alt="Your Image"
            objectFit="contain"
            width="70%"
          />
        ...
        <Box w="full" p={4} border="2px solid" borderColor="black">
          ...
          <VStack>
            <Text fontSize="md" px={2} as="b">
              Data Badan Informasi Geospasial<br/> Peta RTRW Kabupaten Semarang
              2023-2024
            </Text>
          </VStack>
        </Box>
...
export default BatasAgrowisata;
