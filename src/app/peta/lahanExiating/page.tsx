    ...
    >
      ...
      >
        ...
        <Box w="full" p={4} border="2px solid" borderColor="black">
          ...
          <Image
            src="/maps/batasPerencanaan/skalaBatas_R.svg"
            alt="Your Image"
            objectFit="contain"
            width="100%"
          />
        ...
        <Box w="full" p={4} border="2px solid" borderColor="black">
          ...
          <Image
            src="/maps/existing/legendaExisting.svg"
            alt="Your Image"
            objectFit="contain"
            width="70%"
          />
        ...
        <Box w="full" p={4} border="2px solid" borderColor="black">
          ...
          <VStack>
            <Text fontSize="md" px={2} as="b">
              Data Badan Informasi Geospasial
              <br /> Peta RTRW Kabupaten Semarang 2023-2024
            </Text>
          </VStack>
        </Box>
        <Box w="full" p={4} border="2px solid" borderColor="black">
          ...
          <VStack>
            <Text fontSize="md" px={2} as="b">
              Laurensia Ayu Anggraeni <br /> Wahyu Cahyaningrum Kusumawati
              <br />
              TIM KKN-PPM Universitas Gadjah Mada <br /> Unit JT-005 Periode II
              - 2024
              <br />
              Kecamatan Bandungan
            </Text>
