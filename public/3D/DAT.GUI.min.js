  ...
  var e = /(\d+(\.\d+)?)px/,
    c = {
      ...
      hasClass: function (a, c) {
        return (
          new RegExp("(?:^|\\s+)" + c + "(?:\\s+|$)").test(a.className) || !1
        );
      },
      getWidth: function (b) {
      ...
      if (c.litmus(b))
        return (
          a.each(c.conversions, function (c, f) {
            ...
            if (!1 === e && !1 !== d)
              return (
                (e = d), (d.conversionName = f), (d.conversion = c), a.BREAK
              );
          }),
          a.BREAK
        );
      ...
      Object.defineProperties(this, {
        ...
        closed: {
          ...
          set: function (b) {
            ...
            this.onResize();
            c.__closeButton &&
              (c.__closeButton.innerHTML = b ? m.TEXT_OPEN : m.TEXT_CLOSED);
          },
        },
        load: {
          get: function () {
  ...
  (dat.controllers.ColorController = (function (f, a, d, e, c) {
    ...
    var q = function (f, n) {
      ...
      c.extend(this.__field_knob.style, {
        ...
        height: "12px",
        border:
          this.__field_knob_border + (0.5 > this.__color.v ? "#fff" : "#000"),
      ...
      c.extend(y.style, { width: "100%", height: "100%", background: "none" });
    ...
    c.extend(q.prototype, f.prototype, {
      updateDisplay: function () {
        ...
        c.extend(this.__field_knob.style, {
          ...
          border:
            this.__field_knob_border + "rgb(" + l + "," + l + "," + l + ")",
        });
        ...
        c.extend(this.__input.style, {
          ...
          color: "rgb(" + l + "," + l + "," + l + ")",
          textShadow:
            this.__input_textShadow + "rgba(" + p + "," + p + "," + p + ",.7)",
        });
      },
    });
